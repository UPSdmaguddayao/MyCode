...
/**
 * Helper class to help classify the difference between a Sphere and a Triangle.  Both have similar methods
 * Any input values are there since the other primitives need their input
