...
public class MainActivity extends Activity implements OnItemSelectedListener
{
	...
	//for UI/spinners/etc
	private HashMap<String,Integer> colorsByName; //spinner for colors
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		//Set up mode spinner
		modeSpinner = (Spinner) findViewById(R.id.draw_mode_spinner); //found in string.xml
		...
		colorsByName = new HashMap<String,Integer>(); //best here than string.  Less setting of variables
		...
		ArrayAdapter<String> colorAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item,
				new String[] {"White","Black", "Red", "Green", "Blue","Yellow"});
